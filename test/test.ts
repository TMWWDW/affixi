...
console.log(psuffix.case(Affixi.Types.Pronoun.PluralFirst).of("çakmak"));
console.log(psuffix.case(Affixi.Types.Pronoun.PluralSecond).of("çakmak"));
console.log(psuffix.case(Affixi.Types.Pronoun.PluralThird).of("çakmak"));
